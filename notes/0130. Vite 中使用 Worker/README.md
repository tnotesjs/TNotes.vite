# [0130. Vite 中使用 Worker](https://github.com/tnotesjs/TNotes.vite/tree/main/notes/0130.%20Vite%20%E4%B8%AD%E4%BD%BF%E7%94%A8%20Worker)

<!-- region:toc -->

- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. `new Worker`](#3-new-worker)
- [4. `?worker`](#4-worker)
- [5. `?sharedworker`](#5-sharedworker)
- [6. Worker 类型声明](#6-worker-类型声明)
- [7. Worker 打包](#7-worker-打包)
