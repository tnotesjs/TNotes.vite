# [0082. 常用社区插件](https://github.com/tnotesjs/TNotes.vite/tree/main/notes/0082.%20%E5%B8%B8%E7%94%A8%E7%A4%BE%E5%8C%BA%E6%8F%92%E4%BB%B6)
...
- [2. 评价](#2-评价)
- [3. 自动导入插件](#3-自动导入插件)
- [4. 组件自动注册插件](#4-组件自动注册插件)
- [5. SVG 插件](#5-svg-插件)
- [6. Mock 插件](#6-mock-插件)
- [7. PWA 插件](#7-pwa-插件)
- [8. ESLint 插件](#8-eslint-插件)
- [9. Checker 插件](#9-checker-插件)
- [10. Compression 插件](#10-compression-插件)
- [11. Inspect 插件](#11-inspect-插件)
