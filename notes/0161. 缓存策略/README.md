# [0161. 缓存策略](https://github.com/tnotesjs/TNotes.vite/tree/main/notes/0161.%20%E7%BC%93%E5%AD%98%E7%AD%96%E7%95%A5)

<!-- region:toc -->

- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. HTML 不强缓存](#3-html-不强缓存)
- [4. JS / CSS 强缓存](#4-js--css-强缓存)
- [5. 文件 Hash](#5-文件-hash)
- [6. CDN 缓存](#6-cdn-缓存)
- [7. 缓存失效策略](#7-缓存失效策略)
