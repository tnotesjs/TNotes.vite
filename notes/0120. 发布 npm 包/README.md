# [0120. 发布 npm 包](https://github.com/tnotesjs/TNotes.vite/tree/main/notes/0120.%20%E5%8F%91%E5%B8%83%20npm%20%E5%8C%85)

<!-- region:toc -->

- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. `package.json` 配置](#3-packagejson-配置)
- [4. `exports`](#4-exports)
- [5. `main`](#5-main)
- [6. `module`](#6-module)
- [7. `types`](#7-types)
- [8. `files`](#8-files)
- [9. `publishConfig`](#9-publishconfig)
- [10. 版本管理](#10-版本管理)
