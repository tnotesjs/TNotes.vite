# [0054. PostCSS](https://github.com/tnotesjs/TNotes.vite/tree/main/notes/0054.%20PostCSS)

<!-- region:toc -->

- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. PostCSS 配置](#3-postcss-配置)
- [4. Autoprefixer](#4-autoprefixer)
- [5. postcss-preset-env](#5-postcss-preset-env)
- [6. px 转 rem](#6-px-转-rem)
- [7. CSS 兼容性处理](#7-css-兼容性处理)
