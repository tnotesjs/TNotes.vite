# [0037. CSS 配置](https://github.com/tnotesjs/TNotes.vite/tree/main/notes/0037.%20CSS%20%E9%85%8D%E7%BD%AE)

<!-- region:toc -->

- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. `css.modules`](#3-cssmodules)
- [4. `css.preprocessorOptions`](#4-csspreprocessoroptions)
- [5. `css.postcss`](#5-csspostcss)
- [6. `css.devSourcemap`](#6-cssdevsourcemap)
- [7. `css.transformer`](#7-csstransformer)
